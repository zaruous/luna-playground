...
**측정 시점은 2026-08-21 이고 그때 얼어 있던 코퍼스입니다.** 코퍼스는 계속
자라므로 지금 원장을 재면 숫자가 다릅니다 — 같은 날 저녁의 실제 원장은 파일
807개 · 이벤트 12,319건 · 987,623,731 토큰이었습니다(아래 표는 805 · 12,307 ·
987,546,843). 이 문서의 숫자를 현재값으로 갱신하지 않는 이유는, 아래의 항등식
판정과 중복 집계가 **그 시점의 그 코퍼스**에 대한 전수 결과이고 다른 코퍼스의
숫자를 섞으면 어느 것도 전수가 아니게 되기 때문입니다.
